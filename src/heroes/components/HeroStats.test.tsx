...
const mockUseHeroesSummary = vi.mocked(useHeroesSummary);
...
const renderHeroStats = (mockData?: Partial<SummaryInformationResponse>) => {
  ...
  if (mockData) {
    mockUseHeroesSummary.mockReturnValue({
      data: mockData,
...
describe('HeroStats', () => {
  ...
  test('should render hero stats with mock data', () => {
  ...
  test('should change the percentage of favorite when a hero is added', () => {
